...
// VIP orders hide prices until the seller has set a final price per item.
...
<?php if ( $is_vip && ! $priced ) : ?>
	<p><em><?php esc_html_e( 'Giá của các sản phẩm sẽ được đội ngũ EPIC xác nhận và thông báo với bạn sau khi đơn hàng được duyệt.', 'epic-wholesale-orders' ); ?></em></p>
<?php endif; ?>
