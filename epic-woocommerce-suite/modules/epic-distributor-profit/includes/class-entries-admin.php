		...
		wp_localize_script(
			...
			array(
				...
				'i18n'         => array(
					...
					'estCostLabel'         => __( 'est. cost', 'epic-distributor-profit' ),
					'costEstimated'        => __( 'Auto-filled from EPIC Product Cost — check before saving.', 'epic-distributor-profit' ),
					'costEstimatedPartial' => __( 'Auto-filled from EPIC Product Cost, but some products in this order have no cost on file — check before saving.', 'epic-distributor-profit' ),
				),
			)
		);
	}
	...
	public static function render_page() {
		...
		<div class="wrap epic-distributor-profit">
			...
			<div class="epic-dp-order-picker">
				...
				<p class="description">
					<?php if ( class_exists( 'Epic_Product_Cost' ) ) : ?>
						<?php esc_html_e( 'Picking an order fills in the fields below (product, quantity, revenue, shipping, and an estimated cost from EPIC Product Cost) — you can still edit anything before saving. Leave this blank for a manual/off-platform sale.', 'epic-distributor-profit' ); ?>
					<?php else : ?>
						<?php esc_html_e( 'Picking an order fills in the fields below (product, quantity, revenue, shipping) — you can still edit anything before saving. Leave this blank for a manual/off-platform sale.', 'epic-distributor-profit' ); ?>
					<?php endif; ?>
				</p>
			</div>
			...
			<form method="post" id="epic-dp-entry-form">
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<input type="number" step="0.01" id="cost" name="cost" class="epic-dp-calc" required
								value="<?php echo esc_attr( $editing ? $editing->cost : '' ); ?>" />
							<?php if ( class_exists( 'Epic_Product_Cost' ) ) : ?>
								<p class="description" id="epic-dp-cost-hint" style="display:none;"></p>
							<?php endif; ?>
						</td>
					</tr>
					<tr>
