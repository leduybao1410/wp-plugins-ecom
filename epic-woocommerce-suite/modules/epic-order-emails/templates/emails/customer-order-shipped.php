...
<p>
	...
	printf(
		...
		esc_html( epic_email_str( 'os_shipped', $epic_locale ) ),
...
<table cellspacing="0" cellpadding="6" style="width:100%; border:1px solid #e5e5e5; margin: 16px 0;">
	<tr>
		<td style="padding:12px; background:#f7f7f7;">
			<strong><?php echo esc_html( epic_email_str( 'os_tracking_label', $epic_locale ) ); ?></strong><br />
	...
	<tr>
		<td style="padding:0 12px 12px;">
			<a href="<?php echo esc_url( $tracking_url ); ?>"><?php echo esc_html( epic_email_str( 'os_track', $epic_locale ) ); ?></a>
			<br />
			<span style="font-size:12px; color:#666;">
				<?php echo esc_html( epic_email_str( 'os_track_hint', $epic_locale ) ); ?>
			</span>
		</td>
	</tr>
	<?php endif; ?>
	...
	<tr>
		<td style="padding:0 12px 12px;">
			<strong><?php echo esc_html( epic_email_str( 'os_eta', $epic_locale ) ); ?></strong>
	...
	<tr>
		<td style="padding:0 12px 12px;">
			<strong><?php echo esc_html( epic_email_str( 'os_cod', $epic_locale ) ); ?></strong>
