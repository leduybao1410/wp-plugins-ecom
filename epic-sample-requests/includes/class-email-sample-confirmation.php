...
class Epic_Email_Sample_Confirmation extends WC_Email {
	...
	public function get_heading() {
		if ( function_exists( 'epic_email_locale' ) && function_exists( 'epic_email_str' ) ) {
			return epic_email_str( 'heading_sample', epic_email_locale( $this->request_locale ) );
		}
	...
	public function get_subject() {
		if ( function_exists( 'epic_email_locale' ) && function_exists( 'epic_email_str' ) ) {
			return $this->format_string( epic_email_str( 'subject_sample', epic_email_locale( $this->request_locale ) ) );
		}
