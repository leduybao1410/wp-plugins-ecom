...
class Epic_Email_Sample_Request extends WC_Email {
	...
	public function trigger( $data ) {
		...
		if ( function_exists( 'epic_email_locale' ) && function_exists( 'epic_email_str' ) ) {
			...
			$this->heading = epic_email_str( 'sp_admin_heading', $epic_locale );
			$this->subject = epic_email_str( 'sp_admin_subject', $epic_locale );
		}
	...
	public function get_heading() {
		if ( function_exists( 'epic_email_locale' ) && function_exists( 'epic_email_str' ) ) {
			return epic_email_str( 'sp_admin_heading', epic_email_locale( $this->request_locale ) );
		}
	...
	public function get_subject() {
		if ( function_exists( 'epic_email_locale' ) && function_exists( 'epic_email_str' ) ) {
			return $this->format_string( epic_email_str( 'sp_admin_subject', epic_email_locale( $this->request_locale ) ) );
		}
